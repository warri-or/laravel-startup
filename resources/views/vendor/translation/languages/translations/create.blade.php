    ...
    <div class="panel w-1/2">
        ...
        <form action="{{ route('languages.translations.store', $language) }}" method="POST">
            ...
            <fieldset>
                ...
                <div class="panel-body p-4">
                    ...
                    <div class="input-group">
                        ...
                        <button data-style="zoom-in" v-on:click="toggleAdvancedOptions" class="text-blue">{{ __('translation::translation.advanced_options') }}</button>
            ...
            <div class="panel-footer flex flex-row-reverse">
                ...
                <button class="button button-blue" data-style="zoom-in">
