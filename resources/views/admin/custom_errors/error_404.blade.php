            ...
            <div class="col-lg-5">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-muted mb-0">{{__("Sorry, but the page you are looking for has not been found. Try checking the URL for error, then hit the refresh button on your browser or try to find something else in our app.")}}</p>
                        </div>
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        <p class="text-white-50">{{__('Return to ')}}<a href="{{env('APP_URL')}}" class="text-white ml-1"><b>{{__('Home')}}</b></a></p>
                    </div> <!-- end col -->
                </div>
                <!-- end row -->
