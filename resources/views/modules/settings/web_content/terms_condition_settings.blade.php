@extends('admin.layouts.app',['menu'=>'settings','sub_menu'=>'termsConditionSettings'])
@section('style')
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group ">
                                <label class="col-form-label" for="terms_condition">{{__('Terms and conditions')}}</label>
                                <textarea name="terms_condition" id="summernote-basic" class="terms_condition_class">{!! $settings->terms_condition ?? '' !!}</textarea>
                            </div>
...
@section('script')
    ...
    <script>
        ...
        $(document).on('click','.submit_settings', function (e) {
            Ladda.bind(this);
            let load = $(this).ladda();
            let option_key = 'terms_condition';
            let option_value = $('.terms_condition_class').val();
