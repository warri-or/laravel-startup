...
function statusFormatter(e, t) {
    var n;
    "Paid" == e ? n = "success" : "Unpaid" == e ? n = "warning" : "Shipped" == e ? n = "info" : "Refunded" == e && (n = "danger");
    t.id;
...
$(document).ready(function () {
    ...
    t.on("check.bs.table uncheck.bs.table check-all.bs.table uncheck-all.bs.table", function () {
