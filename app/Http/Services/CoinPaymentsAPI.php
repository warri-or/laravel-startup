...
use App\Models\CoinPaymentApiLog;
...
class CoinPaymentsAPI {
    ...
    {
        $this->setting = __options(['coin_payment_settings']);
        $this->public_key = $this->setting->coin_payment_public_key ?? 'a7878cc0e7a6fe94acb5bec41e1773b3a7e17da610c36dc93812a300491aa99d';
        $this->private_key = $this->setting->coin_payment_private_key ?? '42c5F6Ab491e75c776fb7544e13755736e766F23A1087665dA857978753042d4';
        $this->ch = null;
    }
   //Add to Database Log
    protected function addToLog($request_body=null, $curl_object=null, $response=null){
        ...
        CoinPaymentApiLog::create(['request_body'=>$request_body, 'curl_object'=>$curl_object, 'response' => $response,'user_id' => $userId]);
    }
