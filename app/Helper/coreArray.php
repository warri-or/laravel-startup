...
if (!function_exists('times')) {
    function times($code = NULL) {
        $times = ['12AM' => '12AM', '1AM' => '1AM', '2AM' => '2AM', '3AM' => '3AM', '4AM' => '4AM', '5AM' => '5AM', '6AM' => '6AM', '7AM' => '7AM', '8AM' => '8AM', '9AM' => '9AM', '10AM' => '10AM', '11AM' => '11AM', '12PM' => '12PM', '1PM' => '1PM', '2PM' => '2PM', '3PM' => '3PM', '4PM' => '4PM', '5PM' => '5PM', '6PM' => '6PM', '7PM' => '7PM', '8PM' => '8PM', '9PM' => '9PM', '10PM' => '10PM', '11PM' => '11PM'];
        if ($code !== NULL) {
            return $times[$code] ?? NULL;
        }
        return $times;
    }
}
...
if (!function_exists('languages')) {
    function languages($code = NULL) {
        $languages = ['en'=>__('English'),'no'=>__('Norway')];
        if ($code !== NULL) {
...
function payment_status($input = NULL) {
    $output = [
        PAYMENT_NOT_DONE    => __('Payment Not Done'),
        PAYMENT_IN_PROGRESS => __('Waiting for payment'),
        PAYMENT_DONE        => __('Payment Complete'),
        PAYMENT_CANCEL      => __('Payment Cancelled'),
    ];
...
// activation status
function activation_status($input = NULL) {
    $output = [
        ACTIVE   => __('Active'),
